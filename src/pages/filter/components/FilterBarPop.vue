    ...
    <div class="filterbarpop-wrap" v-if="visible" :style="{'top': bgTop + 'px'}">
      ...
      <div class="filterbarpop">
        <div class="tab-bar" v-show="hasTabHeader">
          <a href="javascript:;" :style="{'flex': column}" role="button"
             @click="clickTab(tab, index)" v-for="(tab, index) in menu.tabs"
        ...
        <div class="main">
          <div class="main-sidebar" :class="{'full-line': !items,'bg-style':items,'line-style':!items,}">
            <div v-if="menu.type !== 'filter'" class="item" @click="clickSidebar(sidemenu, index)"
            ...
            <div v-if="menu.type == 'filter'" v-for="(sm, _index) in menu.tabs">
              ...
              <div class="filter-item">
                <span v-for="(sidemenu, index) in sm.detailList" class="item-operation"
          ...
          <div class="main-list line-style" v-if="items">
            <span class="item" @click="clickItem(item, index)" v-for="(item, index) in items.list"
                  :class="{'selected': currentSelectIndex == sideMenus.selectIndex && items.selectIndex == index}">{{item.name}}</span>
          </div>
        </div>
      </div>
    </div>
